...
Ler qué es lo que grafica la función voom.
```{r modelo2}
...
Siguiendo con el análisis, se observó si se generaban clusters de expresión diferencial. Esto se consiguió a partir de gráficas MDS en las que visualizamos la agrupación de muestras de acuerdo a los valores  y los niveles de expresión de las variables elegidas.De igual manera, se graficaron los atributos grupo de edad, fenotipo y género . 
